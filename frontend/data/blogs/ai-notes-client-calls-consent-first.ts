...
export const ai_notes_client_calls_consent_first: BlogPost = {
  ...
  content: `<section class="prose-article">
      ...
      <p>For related source and delivery controls, compare this with our <a href="/blog/ai-deep-research-source-first-workflow">source-first AI research workflow</a> and <a href="/blog/ai-coding-agents-pr-first-workflow-small-teams">PR-first AI coding workflow</a>. Both use the same pattern: define the boundary first, then verify the output before handoff.</p>
